...
void loop() 
{
  ...
  /**
    *  The next block checks to handle data a user can send to the robot in order to modify it's prorgramming. this can be used to tune, and even directly controler the robot.
