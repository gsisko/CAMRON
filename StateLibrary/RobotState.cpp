...
RobotState::RobotState(int initialX, int initialY, float _P = .42, float _I = 0, float _D = 0, float _desired = 1)
{
	PosX = initialX;
	PosY = initialY;
	SpeedX = 0;
	...
	GoalPositionX = 0;
	GoalPositionY = 0;
	controller = new PIDControl<float>(&EraserForce, &ScrewSpeed, _P, _I, _D, _desired);
	/*GoalForce = 0;
	  P = 0; 
	  I = 0; 
	  D = 0;
